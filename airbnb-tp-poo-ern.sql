...
INSERT INTO `type_logement` (`id`, `label`) VALUES
	(1, 'Logement entier'),
	(2, 'Chambre privée'),
	(3, 'Chambre partagée'),
	(4, 'Maisons troglodytes'),
	(5, 'Cabanes perchées'),
	(6, 'Design'),
	(7, 'Sur l\'eau'),
	(8, 'Grandes demeures'),
	(9, 'Wow!'),
	(10, 'Maisons en container');
...
INSERT INTO `adresse` (`id`, `rue`, `code_postal`, `ville`, `pays`) VALUES
	(1, '2, allée des Primevères', '54840', 'Velaine-en-Haye', 'France');
...
INSERT INTO `utilisateur` (`id`, `email`, `mot_de_passe`, `is_annonceur`, `adresse_id`) VALUES
	(1, 'toto@toto.com', 'e2774105b64eeb7efb28a23e407054b060dcb9de068dcc9bbfa9091f165508bf00bda8b74b9e181065945da9b62ce201d16020d1361d2bd0727a3524397d6fbb', TRUE, 1),
	(2, 'doe@doe.com', '0e160bbc55e512064a50280e7edcf24ce89102f84be499bd3e3ca1c159158a544ca941f6372df53dedfbf52cf75cec75bbec05cea480fec7a825ad85e8cdacd3', FALSE, 1);
...
INSERT INTO `annonce` (`id`, `titre`, `adresse_id`, `utilisateur_id`, `prix`, `type_logement_id`, `taille`, `nb_pieces`, `description`, `nb_couchages`) VALUES
	(1, 'Mon super logement', 1, 1, 150, 1, 300, 12, 'Maison entière sur deux étages avec jardin et petite piscine. Le tout dans un quartier calme en pleine campagne en lorraine. Idéal pour les amateurs de calme et de ballades en forêt.', 10);
...
INSERT INTO `reservation` (`id`, `annonce_id`, `utilisateur_id`, `date_debut`, `date_fin`) VALUES
	(1, 1, 1, '2023-09-10 00:00:00','2023-09-14 00:00:00');
...
INSERT INTO `photo` (`id`, `image_path`, `annonce_id`) VALUES
	(1, 'mon-logement.jpg', 1);
...
INSERT INTO `annonce_equipement` (`id`, `annonce_id`, `equipement_id`) VALUES
	(1, 1, 1);
